...
$grid.Columns['Pull'].DisplayIndex = 4
$grid.Columns['AI'].DisplayIndex = 5
$grid.Columns['10x'].DisplayIndex = 6
$grid.Columns['Diff'].DisplayIndex = 7
$grid.Columns['Dirty'].DisplayIndex = 8
